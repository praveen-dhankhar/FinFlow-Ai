...
Sentry.init({
  ...
  beforeSend(event, hint) {
    ...
    // Add server context
    event.server_name = process.env.NEXT_PUBLIC_APP_NAME || 'finance-forecast-server'
  ...
  beforeBreadcrumb(breadcrumb) {
    ...
    if (breadcrumb.category === 'db' && process.env.NODE_ENV === 'production') {
      return null
    }
  ...
  serverName: process.env.NEXT_PUBLIC_APP_NAME || 'finance-forecast-server',
